    ...
    <div>
        <div class="page-name">
            ...
            <div class="add_object">
                <router-link :to="{name: 'blogAdd'}" class="btn btn-success" >Добавить</router-link>
            </div>
        </div>

        <div lass="form-delete">
			...
			<div v-for="object in objects" :key="object.id" :class="['object']">
                ...
                <router-link :to="{name: 'blogEdit', params: { id: object.id }}" class="object_name" >{{ object.name }}</router-link>
    ...
    export default {
    	...
    	mounted: function (){
    		this.$nextTick(function(){
    			...
    			let o = this;
    			axios.get(o.$store.state.domain + '/blogs/get').then(function(response){
    	...
    	methods: {
    		...
    		deleteObjects: function(){
    			...
    			axios.post(o.$store.state.domain + '/blogs/delete', formData).then(function(response){
					axios.get(o.$store.state.domain + '/blogs/get').then(function(response){
	    				o.objects = JSON.parse(response.data.objects);
	    			}).catch(function (error){
	    				console.log(error);
