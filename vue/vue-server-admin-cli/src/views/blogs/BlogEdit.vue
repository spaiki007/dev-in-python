    ...
    export default {
        ...
        mounted: function (){
            this.$nextTick(function(){
				...
				axios.get(o.$store.state.domain + '/blogs/' + o.$route.params.id).then(function(response){

                    o.name      	= response.data.name;
					o.pre_content 	= response.data.pre_content;
        ...
        methods: {
            ...
            editObject: function(){
                ...
                axios.post(o.$store.state.domain + '/blogs/' + o.$route.params.id + '/update', data).then(function(response){
