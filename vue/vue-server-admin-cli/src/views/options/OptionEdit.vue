    ...
    export default {
        ...
        mounted: function (){
            this.$nextTick(function(){
                let o = this;
                axios.get(o.$store.state.domain + '/options/' + o.$route.params.id).then(function(response){
        ...
        methods: {
            ...
            editObject: function(){
                ...
                axios.post(o.$store.state.domain + '/options/' + o.$route.params.id + '/update', data).then(function(response){
