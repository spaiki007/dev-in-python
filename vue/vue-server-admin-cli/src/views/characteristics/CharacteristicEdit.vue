<template>
    <div>
        <h2>Изменение характеристики</h2>
    ...
    export default {
        ...
        mounted: function (){
            this.$nextTick(function(){
                let o = this;
                axios.get(o.$store.state.domain + '/characteristics/' + o.$route.params.id).then(function(response){
        ...
        methods: {
            ...
            editObject: function(){
                ...
                axios.post(o.$store.state.domain + '/characteristics/' + o.$route.params.id + '/update', data).then(function(response){
